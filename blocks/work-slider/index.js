( function ( blocks, element, serverSideRender, blockEditor, components ) {
	...
	blocks.registerBlockType( 'tajwar/work-slider', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					'div',
					blockProps,
					el( serverSideRender, { block: 'tajwar/work-slider', attributes: attributes } )
				)
			);
		},
		save: function () {
			// Dynamic block -- rendered entirely by render.php from the
			// Work Site custom post type, nothing to save client-side.
			return null;
		},
	} );
